...
featNames = c("CL_GrowthRate", "meanEccentricity", "Perimeter_Area", "Displacement_Distance",
...
# p
ggsave(filename = paste0(workdir,"images/tSNE_2D_AllCell_perplexity_50_CL_color01.png"),
...
save(tsne_plot_01, tsne_out_01, metadata, dataFeat, ClusterData,
