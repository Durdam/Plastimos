...
df_growthrate$LogisticGrowth_fit = c(fitted_line1, fitted_line2, fitted_line3)
...
GrowthRate_model_Output$LogisticGrowthFit = c(growth_rate_cl1_logistic, growth_rate_cl2_logistic, growth_rate_cl3_logistic)
